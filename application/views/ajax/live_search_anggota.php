	      ...
	      <div class="table-responsive mt-4" data-aos="zoom-out" data-aos-delay="300">
	        ...
	        <?php foreach ($data_anggota as $anggota): ?>
	            <tr class="bg-light" data-aos="zoom-out" data-aos-delay="100">
	              ...
	              <td class="bg-transparent"><strong><?= $anggota->nama_anggota ?></strong></td>
	...
	<div class="card" data-aos="zoom-out" data-aos-delay="100">
        <div class="card-body">
          <div class="d-flex justify-content-between">
            ...
            <button class="btn btn-primary" type="button" data-bs-toggle="modal" data-bs-target="#modalTambahAnggota" data-aos="zoom-out" data-aos-delay="300"><i class="ti ti-plus"></i>Tambah Anggota</button>
          </div>
